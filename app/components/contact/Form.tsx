...
const TerminalHeader = () => {
  return (
    <div className="w-full p-3 bg-slate-200 dark:bg-slate-600 transition-colors flex items-center gap-1 sticky top-0">
...
const TerminalBody = ({ containerRef, inputRef }: TerminalBodyProps) => {
  ...
  return (
    <div className="p-2 text-slate-800 dark:text-slate-100 text-lg">
      <InitialText />
...
const InitialText = () => {
  return (
    <>
      <p>Hey there! I&apos;m excited to meet.</p>
